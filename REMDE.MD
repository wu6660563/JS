...
他来源补充好资源。
- 整理后的内容，将收录在[伯乐在线资源频道](http://hao.jobbole.com/)。可参考已整理

的内容：
  - 《[jQWidgets：jQuery HTML5 UI组件框架](http://hao.jobbole.com/jqwidgets-
...
- 维护者：
- 贡献者：[刘健超](https://github.com/JChehe)、MissNull、一兮、Mr. Somebody、Jason 

Lee、[Tab_Gre](http://www.jobbole.com/members/ivanberry/)、[GavinZhang]
...
[cike8899](https://github.com/cike8899)、[cnzin](https://github.com/cnzin)、

[cike8899](https://github.com/cike8899)
...
* Duo：一个整合 Component、Browserify 和 Go [官网](https://github.com/duojs/duo)的
...
HTML/text 和历史脚本。[官网](https://github.com/cujojs/curl)
...
[官网](https://github.com/substack/node-browserify)
...
器端和 node.js。[官网](https://github.com/alex-seville/blanket)
...
* karma：一个优秀的的 JavaScript 测试运行器。[官网](https://github.com/karma-
...
* buddy.js：发现 JavaScript 代码里的 [魔术数字](https://zh.wikipedia.org/wiki/
...
* [angular.js](http://hao.jobbole.com/angularjs/)：为网络应用增强 HTML。[官网]
...
Backbone。[官网](https://github.com/jashkenas/backbone)
...
为其不同的实现。[官网](https://facebook.github.io/react/)
...
。[官网](https://github.com/marionettejs/backbone.marionette)
...
官网](https://github.com/derbyjs/derby)
    * derby-awesome：很棒的 derby 组件集合。[官网]

(https://github.com/russll/awesome-derby)
* [way.js](http://hao.jobbole.com/way-js/)：简单、轻量、持久化的双向数据绑定。[官
...
[官网](https://github.com/blueimp/JavaScript-Templates)
...
译后输出。适用于 Node.js [官网](https://github.com/marko-js/marko)和浏览器。
...
移植到 JavaScript [官网](https://github.com/paperjs/paper.js)和浏览器。
...
也有一些很棒的收费库，如 [amchart](https://www.amcharts.com/)、[plotly]

(https://plot.ly/) 和 [highchart](http://www.highcharts.com/)。
...
* [quill](http://hao.jobbole.com/quill/)：一个带有 API 的跨浏览器富文本编辑器。([
...
解析、操作、序列化、存储）操作。[官网](https://github.com/jDataView/jBinary)

<h3 id="functional-programming">函数式编程</h3>

函数式编程库扩展了 JavaScript 的能力。

* [underscore](http://hao.jobbole.com/underscore/)：JavaScript 的实用工具。[官网]

(https://github.com/jashkenas/underscore)
* [lodash](http://hao.jobbole.com/lodash/)：提供一致性、可定制、高性能和额外功能的

实用库。[官网](https://github.com/lodash/lodash)
...
* RxJs：对 JavaScript 进行响应式扩展。[官网](https://github.com/Reactive-
...
，而且仅使用标准 JavaScript 和类 Node 流。[官网](http://highlandjs.org/)
...
Set 和 sparse Vector。[官网](https://github.com/facebook/immutable-js)
...
时区数据。[官网](https://github.com/mde/timezone-js)
...
化。[官网](https://github.com/snd/url-pattern)
...
操作简单和强大的 API。[官网](https://github.com/mozilla/localForage)
...
localStorage / websql / [官网](https://github.com/nodeca/bag.js)undexedDB 的支持。
...
器行为一致）。[官网](https://github.com/gartz/ObjectEventTarget)
...
* [angular-ui-router](http://hao.jobbole.com/angular-ui-router/)：基于AngularJS的

可嵌套路由。[官网](http://angular-ui.github.io/ui-router/)
...
示在页面内。[官网](https://github.com/Oaxoa/Conzole)
...
加可靠的日志等级。[官网](https://github.com/pimterry/loglevel)
...
PCRE。[官网](https://regex101.com/#javascript)
...
除了上述这些库，还有收藏在 [Codepen](http://codepen.io/collection/HtAne/) 的，另外

还有 [Ajaxload](http://www.ajaxload.info/)，[Preloaders](http://preloaders.net/) 
...
的操作）。[官网](https://github.com/chriso/validator.js)
...
。[官网](https://github.com/nghuuphuoc/bootstrapvalidator)
* [is.js](http://hao.jobbole.com/is-js/)：检查类型、正则表达式、是否存在、时间等。

[官网](https://github.com/arasatasaygin/is.js)
...
的痛苦。[官网](https://github.com/RobertWHurst/KeyboardJS)
* jquery.hotkeys：jQuery Hotkeys 能让你在代码任何的地方监听键盘事件，并几乎支持所

有按键组合。[官网](https://github.com/jeresig/jquery.hotkeys)
...
工具。[官网](https://github.com/fancyapps/fancyBox)
...
框架。[官网](https://github.com/IanLunn/Sequence)
...
件。[官网](https://github.com/dimsemenov/PhotoSwipe)
...
酷酷的标签列表。[官网](https://github.com/xoxco/jQuery-Tags-Input)
...
器。[官网](https://github.com/amsul/pickadate.js)
...
入框。[官网](https://github.com/felicegattuso/datedropper)
...
限滚动。[官网](https://github.com/select2/select2)
...
片、音频、视频预览的 [官网](https://github.com/blueimp/jQuery-File-Upload)jQuery 

插件。
* dropzone：Dropzone 是一个易于使用且支持多文件拖放的库。其支持图片预览并且拥有很

好的进度条效果。[官网](https://github.com/enyo/dropzone)
* flow.js：一个通过 HTML5 的 File API ，提供多个同时链接的、稳定的、容错的、可恢复

的/可重新开始的文件上传库。[官网](https://github.com/flowjs/flow.js)
...
支持裁剪、调整大小和根据 [EXIF](http://baike.baidu.com/view/22006.htm) 自动调整方

向。[官网](https://github.com/mailru/FileAPI)
...
函数。[官网](https://github.com/RadLikeWhoa/Countable)
...
jQuery 插件。[官网](https://github.com/vast-engineering/jquery-popup-overlay)
...
* jquery-popbox：jQuery 提示框插件。[官网](https://github.com/gristmill/jquery-
...
ajax 等。[官网](https://github.com/jschr/bootstrap-modal)
...
面电脑。[官网](https://github.com/Prinzhorn/skrollr)
...
* ScrollMenu：让老旧无聊的滚动条焕然一新。[官网](https://github.com/s-
...
量的下拉菜单，如 Amazon 的。[官网](https://github.com/kamens/jQuery-menu-aim)
...
HTML 表格。（jQuery 插件）[官网](http://www.datatables.net/) 
* floatThead：（jQuery 插件）锁定表格头部，只允许表格内容滚动。适用于任何表格，而

且不需要额外的 html 或 css。[官网](https://github.com/mkoryak/floatThead)
...
库。[官网](https://github.com/simplegeo/polymaps)
